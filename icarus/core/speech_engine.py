...
def initializer() -> bool:
    porcupine = pvporcupine.create(
        ...
        # INCORRECT PATH! - Need icarus wake word detector model
...
def listen_for_command(repeat: bool) -> str:
    with Speech.Microphone() as src:
        ...
        try:                     ### TODO Find new methods - recog_google is depecrateda
            cmd: str = recognizer.recognize_google(sound, language="en-US")
            print(f"[{color_text('ICARUS', 'blue')}] CMD: {cmd}")
            return cmd.lower()
